...
class CompaniesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'directors' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'modified_by' => 1,
            'created_by' => 1,
            'modified' => '2017-07-03 06:31:11',
            'created' => '2017-07-03 06:31:11'
        ],
    ];
}
